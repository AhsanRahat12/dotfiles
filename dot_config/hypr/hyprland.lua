...
-- Bind for the updates script

hl.bind("SUPER" .. " + " .. "U", hl.dsp.exec_cmd("kitty -e less ~/.cache/update-check.log"))
...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brightnessctl --device=intel_backlight set 5%+"), { locked = true })

hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl --device=intel_backlight set 5%-"), { locked = true })
...
hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("gammastep -l 49.8:-99.9 -t 6500:3500")
